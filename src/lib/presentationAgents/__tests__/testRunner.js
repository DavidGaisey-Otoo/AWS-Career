import { runPresentationReview } from '../master.js';
import { PRESENTATION_SCENARIOS } from './fixtures.js';

export function runAllPresentationTests() {
  const results = PRESENTATION_SCENARIOS.map((scenario) => {
    const review = runPresentationReview(scenario.input);
...
export function printPresentationReport(report) {
  const lines = [];
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('  PRESENTATION AGENT TEST REPORT');
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('');
