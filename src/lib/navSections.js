...
export const SECTIONS = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'github-projects', label: 'Applications & Deploy', icon: Github,      path: '/applications',
        hint: 'Choose a GitHub application, see the required AWS services, then follow Deploy → Verify → Destroy' },
