import { runDocReview } from '../master.js';
import { DOC_SCENARIOS } from './fixtures.js';

export function runAllDocTests() {
  const results = DOC_SCENARIOS.map((scenario) => {
    const review = runDocReview(scenario.input);
...
export function printDocReport(report) {
  const lines = [];
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('  DOCUMENTATION AGENT TEST REPORT');
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('');
