import { runDeployReview } from '../master.js';
import { DEPLOY_SCENARIOS } from './fixtures.js';

export function runAllDeployTests() {
  const results = DEPLOY_SCENARIOS.map((scenario) => {
    const review = runDeployReview(scenario.input);
...
export function printDeployReport(report) {
  const lines = [];
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('  DEPLOY AGENT TEST REPORT');
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('');
