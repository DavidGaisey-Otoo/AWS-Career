import { runContractReview } from '../master.js';
import { CONTRACT_SCENARIOS } from './fixtures.js';

export function runAllContractTests() {
  const results = CONTRACT_SCENARIOS.map((scenario) => {
    const review = runContractReview(scenario.input);
...
export function printContractReport(report) {
  const lines = [];
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('  CONTRACT AGENT TEST REPORT');
  lines.push('═══════════════════════════════════════════════════════════════════');
  lines.push('');
