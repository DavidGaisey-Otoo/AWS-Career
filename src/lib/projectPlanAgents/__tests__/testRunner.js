import { runProjectPlanReview } from '../master.js';
import { PLAN_SCENARIOS } from './fixtures.js';

export function runAllPlanTests() {
  const results = PLAN_SCENARIOS.map((s) => {
    const review = runProjectPlanReview(s.input);
...
export function printPlanReport(report) {
  const lines = ['═══════════════════════════════════════════════════════════════════', '  PROJECT PLAN AGENT TEST REPORT', '═══════════════════════════════════════════════════════════════════', ''];
