...
export const SESSION_TONIGHT = {
  ...
  durationMin: 180,
  account: { id: '851725590283', alias: 'Gaisey', email: 'gaiseyotood@gmail.com', region: 'eu-west-1' },
  outcomes: [
    ...
    { label: 'IAM user "David" with AdministratorAccess', status: 'done', note: 'Console access enabled, password set' },
    { label: 'MFA on IAM user David',                     status: 'done' },
    ...
    { label: '$5 monthly budget with email alert',        status: 'done', note: 'Budget name: monthly-5-dollar-limit, alert at 80%, to gaiseyotood@gmail.com' },
  ...
  steps: [
    {
      ...
      body: 'Signed in as ROOT with gaiseyotood@gmail.com after one wrong-email mis-type (dgaiseyotoo@gmail.com → AWS account does not exist).',
    ...
    {
      n: 3, phase: 'IAM', title: 'Created IAM user "David" with AdministratorAccess',
      action: { type: 'goto', url: 'https://us-east-1.console.aws.amazon.com/iam/home#/users' },
      body: 'IAM → Users → Create user. Username: David. Console access enabled. Custom password set. Attached managed policy: AdministratorAccess.',
      checkpoint: 'User David created, .csv credentials downloaded and saved.',
      durationMin: 6,
    },
    {
      n: 4, phase: 'IAM', title: 'Enabled MFA on IAM user David',
    ...
    },
    {
      ...
      body: 'Billing → Budgets → Create budget → Use template → Monthly cost budget. Name: monthly-5-dollar-limit. Amount: $5 USD. Email: gaiseyotood@gmail.com. Alert at 80%.',
