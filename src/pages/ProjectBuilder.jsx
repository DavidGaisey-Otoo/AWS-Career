    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <OutputCard
          icon={Printer}
          title="PDF / Print"
          description="Branded cover page + clean A4 formatting. Save as PDF in the print dialog."
          action={<Button variant="primary" onClick={doPrintable}>Open print view</Button>}
        />
        <OutputCard
          icon={Github}
          title="GitHub push"
