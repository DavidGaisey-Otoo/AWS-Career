...
export default function SAAHome() {
  ...
  return <div className="space-y-6">
    ...
    <section className="grid grid-cols-2 lg:grid-cols-4 gap-3"><StatChip layout="stacked" icon={Target} label="Overall accuracy" value={stats?.totalQuestionsAnswered ? `${stats.accuracy}%` : '—'} /><StatChip layout="stacked" icon={Clock3} label="Questions attempted" value={stats?.totalQuestionsAnswered || 0}/><StatChip layout="stacked" icon={CheckCircle2} label="Questions correct" value={totalCorrect}/><StatChip layout="stacked" icon={Bookmark} label="Bookmarked" value={bookmarkCount}/></section>
