...
var DynamoDBJsonShapeSerializer = class extends JsonShapeSerializer {
  _write(schema, value, container) {
    ...
    if (ns.isStructSchema() && ns.getName(true) === ATTRIBUTE_VALUE) {
      if (value && typeof value === "object") {
        ...
        const base64Encode = ((_a = this.serdeContext) == null ? void 0 : _a.base64Encoder) ?? toBase64;
        ...
        if (Array.isArray(av.L)) {
          const list = [];
          for (const v2 of av.L) {
            if (v2 != null) {
              list.push(this._write(ns, v2, container));
            }
          }
          out.L = list;
        }
        if (av.M && typeof av.M === "object") {
          out.M = {};
          for (const [k2, v2] of Object.entries(av.M)) {
            if (v2 != null) {
              out.M[k2] = this._write(ns, v2, container);
            }
          }
        }
        return out;
  ...
  copyRemoveNulls(v2) {
    ...
    const out = {};
    for (const [k2, _v] of Object.entries(v2)) {
      if (_v != null) {
        if (["B", "BS", "L", "M"].includes(k2)) {
          continue;
        }
        out[k2] = this.copyRemoveNulls(_v);
      }
    }
    return out;
  }
  ...
  _read(schema, value) {
    ...
    if (ns.isStructSchema() && ns.getName(true) === ATTRIBUTE_VALUE) {
      if (value && typeof value === "object") {
        const av = value;
        const out = av;
        const base64Decoder = ((_a = this.serdeContext) == null ? void 0 : _a.base64Decoder) ?? fromBase64;
        ...
        if (Array.isArray(av.L)) {
          out.L = av.L.map((v2) => this._read(ns, v2));
        }
        if (av.M && typeof av.M === "object") {
          for (const [k2, v2] of Object.entries(av.M)) {
            out.M[k2] = this._read(ns, v2);
          }
        }
        return out;
      }
...
var g = "stringEquals";
var h = "getAttr";
var i = "https://dynamodb.{Region}.{PartitionResult#dualStackDnsSuffix}";
var j = "aws.parseArn";
var k = (n2) => "ParsedArn_ssa_" + n2;
var l = "service";
var m = "dynamodb";
var n = "isValidHostLabel";
var o = "accountId";
var p = "FirstArn";
var q = (n2) => "https://{ParsedArn_ssa_" + n2 + "#accountId}.ddb.{Region}.{PartitionResult#dualStackDnsSuffix}";
var s = (n2) => "https://{ParsedArn_ssa_" + n2 + "#accountId}.ddb.{Region}.{PartitionResult#dnsSuffix}";
var t = { [I]: "Endpoint" };
var u = { [I]: "Region" };
var v = { [I]: f };
var w = { [I]: "AccountIdEndpointMode" };
var x = { "fn": h, [J]: [v, "name"] };
var y = { "fn": h, [J]: [{ [I]: "ParsedArn_ssa_2" }, "region"] };
var z = { [I]: "ParsedArn_ssa_2" };
var A = { [I]: "ResourceArnList" };
var B = { "fn": h, [J]: [{ [I]: "ParsedArn_ssa_1" }, "region"] };
...
var getRuntimeConfig = (config) => {
  return {
    ...
    protocol: (config == null ? void 0 : config.protocol) ?? AwsJson1_0Protocol,
    ...
    retryStrategy: (config == null ? void 0 : config.retryStrategy) ?? ((config == null ? void 0 : config.maxAttempts) == null && (config == null ? void 0 : config.retryMode) == null && Retry.v2026 ? new StandardRetryStrategy({
      maxAttempts: 4,
      baseDelay: 25
    }) : void 0),
...
var TransactGetItemsCommand = class extends Command.classBuilder().ep({
  ...commonParams,
  ResourceArnList: { type: "operationContextParams", get: (input) => {
    var _a;
...
var TransactWriteItemsCommand = class extends Command.classBuilder().ep({
  ...
  ResourceArnList: { type: "operationContextParams", get: (input) => {
    ...
    return (_a = input == null ? void 0 : input.TransactItems) == null ? void 0 : _a.map((obj) => {
      var _a2, _b, _c2, _d;
      return [(_a2 = obj == null ? void 0 : obj.ConditionCheck) == null ? void 0 : _a2.TableName, (_b = obj == null ? void 0 : obj.Put) == null ? void 0 : _b.TableName, (_c2 = obj == null ? void 0 : obj.Delete) == null ? void 0 : _c2.TableName, (_d = obj == null ? void 0 : obj.Update) == null ? void 0 : _d.TableName].filter((i2) => i2);
    }).flat();
  } }
}).m(function(Command2, cs, config, o2) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
// node_modules/@aws-sdk/client-dynamodb/dist-es/waiters/waitForContributorInsightsEnabled.js
...
// node_modules/@aws-sdk/client-dynamodb/dist-es/waiters/waitForExportCompleted.js
...
// node_modules/@aws-sdk/client-dynamodb/dist-es/waiters/waitForImportCompleted.js
...
// node_modules/@aws-sdk/client-dynamodb/dist-es/waiters/waitForKinesisStreamingDestinationActive.js
...
// node_modules/@aws-sdk/client-dynamodb/dist-es/models/enums.js
